    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                ...
                {!!error && (
                  <Alert className="bg-distructive/10 border-none">
          ...
          <div className="bg-radial form-red-700 to-red-900 relative hidden md:flex flex-col gap-y-4 items-center justify-center">
